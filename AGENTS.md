...
- Do not regenerate `reports/v2/sigma_defect.json` in place. It is the recorded reproduction of the v1 sigma defect; re-run it to a scratch path and compare with `scripts/diagnose_replay_determinism.py`.
