# Preregistration — EZ-B001-C

Protocol version: 1.0.0
Evidence protocol version: 0.3.0
Benchmark family: EZ-B001
Preregistration hash: `e563ce856380f4abc51558f91d74d2135d69d0a3379b8c426f4f6e139f4d6c29`
...
Trained only on AME2016, how accurately and how honestly do the
three frozen EZ-B001 models predict the mass excess of nuclides that only
became ground-truth eligible in AME2020?
...
| --- | --- | --- | --- |
| training | AME2016 | `data/raw/amdc/AME2016/mass16.txt` | `2167f57a2a98331e4649b2dd2b658a9006ed4fba1975729ebfe52a42b4b9218a` |
| later truth | AME2020 | `data/raw/amdc/AME2020/mass_1.mas20.txt` | `e8599c6d7f724fac91934e59f1b9de8fb8f63e820f4b39456b790665ed2a3307` |

Training citation: M. Wang, G. Audi, F.G. Kondev, W.J. Huang, S. Naimi, X. Xu, 'The AME2016 atomic mass evaluation (II). Tables, graphs and references', Chinese Physics C 41 (2017) 030003, doi:10.1088/1674-1137/41/3/030003

Later-edition citation: M. Wang, W.J. Huang, F.G. Kondev, G. Audi, S. Naimi, 'The AME2020 atomic mass evaluation (II). Tables, graphs and references', Chinese Physics C 45 (2021) 030003, doi:10.1088/1674-1137/abddaf

Training URL: https://amdc.impcas.ac.cn/masstables/Ame2016/mass16.txt

Later-edition URL: https://amdc.impcas.ac.cn/masstables/Ame2020/mass_1.mas20.txt
...
```text
training_eligible_ids = AME2016 rows with ground_truth_eligible == True
target_ids            = AME2020 rows with ground_truth_eligible == True minus training_eligible_ids
```

An AME2016 estimated row does not remove a target when the corresponding AME2020 row becomes ground-truth eligible.
...
- allowed source hashes: `2167f57a2a98331e4649b2dd2b658a9006ed4fba1975729ebfe52a42b4b9218a`
- forbidden source hashes: `e8599c6d7f724fac91934e59f1b9de8fb8f63e820f4b39456b790665ed2a3307`
